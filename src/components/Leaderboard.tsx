    ...
    return (
      <div style={{
        ...
        <div style={{ fontSize: 11, color: "var(--text-secondary)", fontWeight: 600 }}>
          Leaderboard service is not configured yet.
        </div>
      </div>
    );
  }
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        Compare your Claude Code usage with other developers.
        Only aggregate daily stats are shared — no code or conversation data.
      </div>
      ...
      <div style={{
        ...
        {loading && leaderboard.length === 0 ? (
          ...
          <div style={{
            ...
            No data yet. Start using Claude Code!
          </div>
        ) : (
